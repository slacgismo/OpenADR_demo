...
# resource "aws_lambda_permission" "device_table_event_sqs_lambda_permission" {
#   statement_id  = "AllowExecutionFromSQS"
#   action        = "lambda:InvokeFunction"
#   function_name = aws_lambda_function.lambda_sqs_event.function_name
#   principal     = "sqs.amazonaws.com"

#   source_arn = data.aws_sqs_queue.devices_tables_event_sqs.arn
# }

# resource "aws_lambda_permission" "settings_table_event_sqs_lambda_permission" {
#   statement_id  = "AllowExecutionFromSQS"
#   action        = "lambda:InvokeFunction"
#   function_name = aws_lambda_function.lambda_sqs_event.function_name
#   principal     = "sqs.amazonaws.com"

#   source_arn = data.aws_sqs_queue.settings_tables_event_sqs.arn
# }



# resource "aws_lambda_event_source_mapping" "lambda_sqs_event_source_mapping" {
#   event_source_arn = var.devices_tables_event_sqs_name
#   function_name    = aws_lambda_function.lambda_sqs_event.function_name
