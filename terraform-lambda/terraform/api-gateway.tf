...
locals {
  ...
  # main openapi file
  openapi = jsondecode(file("../api/openapi.json.tpl"))
  # agents openapi file
  agents_paths=  templatefile("../api/agents/paths.json.tpl", {
  ...
  auctions_paths=  templatefile("../api/auctions/paths.json.tpl", {
  ...
  devices_paths=  templatefile("../api/devices/paths.json.tpl", {
  ...
  dispatches_paths=  templatefile("../api/dispatches/paths.json.tpl", {
  ...
  markets_paths=  templatefile("../api/markets/paths.json.tpl", {
  ...
  # meters openapi file
  meters_paths=  templatefile("../api/meters/paths.json.tpl", {
  ...
  meters_json = jsondecode(local.meters_paths)
    ...
    # meters openapi file
  orders_paths=  templatefile("../api/orders/paths.json.tpl", {
  ...
  readings_paths=  templatefile("../api/readings/paths.json.tpl", {
  ...
  resources_paths=  templatefile("../api/resources/paths.json.tpl", {
  ...
  settings_paths=  templatefile("../api/settings/paths.json.tpl", {
  ...
  settlements_paths=  templatefile("../api/settlements/paths.json.tpl", {
  ...
  weather_paths=  templatefile("../api/weather/paths.json.tpl", {
  ...
  # swagger_paths=  templatefile("../api/swagger/paths.json.tpl", {
