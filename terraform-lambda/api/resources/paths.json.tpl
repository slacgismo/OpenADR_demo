    ...
    "paths": {
        "/db/resources/query": {
            "get": {
                ...
                "summary": "Query resources from gsi",
                "description": "Query resources from resources table with gsi or lsi",
                "parameters": [
                    {
                        "name": "gsi_name",
                        "required": true,
        ...
        "/db/resources/scan": {
            "get": {
                ...
                "summary": "scan resources",
                "description": "Scan items from resources table",
                "parameters": [
                    {
                        "name": "key_value",
                        "required": true,
        ...
        "/db/resources": {
            "post": {
                ...
                "description": "Create new resources with the given data",
                "requestBody": {
                    "description": "Data for creating new resources",
                    "required": true,
                    "content": {
                        "application/json": {
                            "schema": {
            ...
            "delete": {
                ...
                "description": "Delete new resources with the given data",
                "requestBody": {
                    "description": "Data for deleting resources",
                    "required": true,
                    "content": {
                        "application/json": {
                            "schema": {
        ...
        "/db/resource/{resource_id}": {
            "get": {
                ...
                "description": "Retrieve the resource with the specified ID",
                "parameters": [
                    {
                        "name": "resource_id",
                        "in": "path",
            ...
            "put": {
                ...
                "summary": "Update an resource by resource_id",
                "description": "Updae an resource with resource_id ",
                "parameters": [
                    {
                        "name": "resource_id",
                        "in": "path",
            ...
            "delete": {
                ...
                "summary": "Delete an resource by resource_id",
                "description": "Delete an resource with resource_id ",
                "parameters": [
                    {
                        "name": "resource_id",
                        "in": "path",
        ...
        "/db/resource": {
            "post": {
                ...
                "summary": "Create an resource by resource_id",
