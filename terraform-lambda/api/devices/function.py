...
def devices_handler(event, context):
    try:
        http_method = event['httpMethod']
        if http_method == 'GET':
            """
            list of devices
            Get /db/devices?agent_id=<agent_id>&valid_at=<valid_at>, Get a list of devices id
            """
            return respond(err=None, res="get list of devices")
        elif http_method == 'PUT':
            raise TESSError("PUT method is not supported")
