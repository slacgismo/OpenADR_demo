[
    {
        "name": "vtn-5ebf01b78c44b180e236ea550eb154",
        "image": "${app_image_vtn}",
        "essential": true,
        ...
        "environment": [
            ...
            {
                "name": "VTN_ID",
                "value": "5ebf01b78c44b180e236ea550eb154"
            },
            {
        ...
        "mountPoints": [
            {
                "readOnly": false,
                "containerPath": "/vol/5ebf01b78c44b180e236ea550eb154",
        ...
        "logConfiguration": {
            ...
            "options": {
                ...
                "awslogs-stream-prefix": "37e675944fd7bffd61d761a55ab51433-5ebf01b78c44b180e236ea550eb154"
            }
        }
    },
    {
        "name": "ven-02678154ae4a4ab8ca819d7f7d1624",
        "image": "${app_image_ven}",
        "essential": true,
        "memoryReservation": 256,
        "runtimePlatform": {
        ...
        "environment": [
            ...
            {
                "name": "VEN_ID",
                "value": "4702339f7f4227bb0b3d0fa189d8fe"
            },
            {
                "name": "AGENT_ID",
                "value": "37e675944fd7bffd61d761a55ab51433"
            ...
            {
                "name": "METER_ID",
                "value": "20abfbf0ae4ee6b984590c524741b2"
            },
            {
                "name": "DEVICE_ID",
        ...
        "mountPoints": [
            {
                "readOnly": false,
                "containerPath": "/vol/02678154ae4a4ab8ca819d7f7d1624",
                "sourceVolume": "agent-volume"
            }
        ],
        "logConfiguration": {
            ...
            "options": {
                "awslogs-group": "${cloudwatch_name}",
                "awslogs-region": "${aws_region}",
                "awslogs-stream-prefix": "37e675944fd7bffd61d761a55ab51433-02678154ae4a4ab8ca819d7f7d1624"
            }
        }
    }
]